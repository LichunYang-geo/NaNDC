...
def save_results(savepath, results, event):
    ...
    for i in range(0, len(event.stations)):
        fo.write("{},{},{},{},{},{},{},{},{},{},{},{},{},{},{},{},{},{},{}\n".format(
            ...
            event.tau1_raw[i], event.pol[i], results.syn_pol[0,i],
            event.tau2_raw[i], event.pamp[i], results.syn_pamp[0,i],
            event.tau3_raw[i], event.spratio[i], results.syn_spratio[0,i] ))
    fo.close()
