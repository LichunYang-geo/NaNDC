...
def plot_misfit_lune_pygmt(savepath, filename, 
    ...
    grid_x, grid_y = np.mgrid[-30:30:120j, -90:90:360j]
    ...
    # fig.text(text="ISO",  x=0.,   y=90.,  offset="0/10p",     no_clip=True)
    # fig.text(text="ISO",  x=0.,   y=-90., offset="0/-10p",    no_clip=True)
    # fig.text(text="CLVD", x=-30., y=0.,   offset="-10p/0p", no_clip=True)
    # fig.text(text="CLVD", x=30.,  y=0.,   offset="10p/0p",  no_clip=True)
